...
4.	Disini yang akan digunakan untuk validasi adalah email dan password
5.	Jadi setelah pengguna mencocokan email dan password, data tersebut akan dikirimkan untuk di cocokkan dengan database yang sudah berisi datanya
6.	Dalam kode tadi, jika field alamat dikosongkan oleh pengguna saat menambah data, maka sistem akan menampilkan pesan error yang menerangkan bahwa field alamat tidak boleh kosong. Proses penyimpanan pun akan dibatalkan atau tidak dilanjutkan.
7.	Ataupun jika terjadi kesalahan saat input data atau data yang dimasukkan tidak cocok dengan yang ada di database, maka proses penyimpanan pun akan dibatalkan atau tidak dilanjutkan.
